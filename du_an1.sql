...
--
-- Host: localhost:3306
-- Generation Time: Nov 13, 2024 at 05:08 AM
...
--
-- Table structure for table `kich_co_san_phams`
--

CREATE TABLE `kich_co_san_phams` (
  `id` int NOT NULL,
  `size` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `kich_co_san_phams`
--

INSERT INTO `kich_co_san_phams` (`id`, `size`) VALUES
(1, 'M'),
(2, 'S'),
(3, 'L'),
(4, 'XL');
...
INSERT INTO `mau_sac_san_pham` (`id`, `mau`) VALUES
(1, 'do'),
(2, 'xanh');
...
INSERT INTO `san_phams` (`id`, `ten_san_pham`, `gia_san_pham`, `gia_khuyen_mai`, `hinh_anh`, `so_luong`, `luot_xem`, `ngay_nhap`, `mo_ta`, `danh_muc_id`, `trang_thai`, `id_kich_co`, `id_mau_sac`) VALUES
(1, 'Nike Air Force 1', 650000.00, NULL, NULL, 12, 10, '2024-11-12', 'giay nike chinh hang sieu dep', 1, 1, 1, 2),
(2, 'Nike Blazer', 430000.00, NULL, NULL, 21, 3, '2024-11-11', 'Dòng giày cổ cao và thấp, mang phong cách cổ điển, thường được phối trong thời trang retro.', 1, 1, 2, 2);
...
--
-- Indexes for table `kich_co_san_phams`
--
ALTER TABLE `kich_co_san_phams`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `kich_co_san_phams`
--
ALTER TABLE `kich_co_san_phams`
